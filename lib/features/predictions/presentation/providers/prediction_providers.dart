...
final Provider<PredictionFirestoreDatasource> predictionFirestoreDatasourceProvider =
    Provider<PredictionFirestoreDatasource>(
  (ref) => PredictionFirestoreDatasource(FirebaseFirestore.instance),
);

final Provider<PredictionRepository> predictionRepositoryProvider = Provider<PredictionRepository>(
